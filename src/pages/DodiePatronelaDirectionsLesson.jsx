...
import { BookOpen, MessageSquare, Users, Map, Compass } from 'lucide-react';
...
const DodiePatronelaDirectionsLesson = () => {
    ...
    const rolePlayQuizData = [
        { situation: "You are lost and want to find the nearest bank.", question: "What do you ask a stranger?", options: ["Where is money?", "Excuse me, where is the nearest bank?", "I need a bank."], answer: "Excuse me, where is the nearest bank?" },
        { situation: "Someone tells you: 'Go straight ahead, then take the second right.'", question: "What do you do?", options: ["Turn right immediately.", "Go forward, then turn right at the second street.", "Turn left."], answer: "Go forward, then turn right at the second street." },
        { situation: "You want to know if the post office is far away.", question: "What do you ask?", options: ["Is it a long walk?", "How many steps?", "Is post office far?"], answer: "Is it a long walk?" },
        { situation: "Someone says, 'The cafe is opposite the park.'", question: "Where is the cafe?", options: ["Next to the park.", "Inside the park.", "Across the street from the park."], answer: "Across the street from the park." },
        { situation: "You need to find a restroom.", question: "What is a polite way to ask?", options: ["Where is the toilet?", "Excuse me, could you tell me where the restroom is?", "I need to go."], answer: "Excuse me, could you tell me where the restroom is?" },
    ];
    ...
    return (
        <div className="font-sans bg-slate-50 min-h-screen">
            <div className="max-w-4xl mx-auto space-y-12 p-4 md:p-8">
                <h1 className="text-4xl font-extrabold text-slate-800 text-center">Travel English: Asking for Directions <span className="text-rose-500">for Dodie & Patronela</span></h1>
                ...
                <WorksheetCard>
                    ...
                    <div className="space-y-4 p-4 bg-slate-50 rounded-lg">
                        <p><strong>Dodie:</strong> Excuse me, we're a little lost. Could you help us?</p>
                        <p><strong>Local:</strong> Of course! Where are you trying to go?</p>
                        <p><strong>Patronela:</strong> We're looking for the City Museum.</p>
                        <p><strong>Local:</strong> Ah, you're close! Go straight down this street for two blocks, then turn left at the traffic lights.</p>
                        <p><strong>Dodie:</strong> So, straight for two blocks, then left?</p>
                        <p><strong>Local:</strong> That's right. You'll see a big park on your right. The museum is opposite the park. You can't miss it!</p>
                        <p><strong>Patronela:</strong> Thank you so much!</p>
                        <p><strong>Local:</strong> You're welcome. Enjoy the museum!</p>
                    </div>
                </WorksheetCard>
...
export default DodiePatronelaDirectionsLesson;